package com.ddastudio.mrmr.profile.model;
...
public class QProfile extends EntityPathBase<Profile> {
    ...
    private static final long serialVersionUID = -671378689L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QProfile profile = new QProfile("profile");

    public final com.ddastudio.mrmr.account.model.QAccount account;
    ...
    public QProfile(Class<? extends Profile> type, PathMetadata metadata, PathInits inits) {
        ...
        this.account = inits.isInitialized("account") ? new com.ddastudio.mrmr.account.model.QAccount(forProperty("account")) : null;
    }
